package top.philsongzi.mydb.backend.parser;

import top.philsongzi.mydb.backend.parser.statement.*;
 ...
 * 这些类在 top.philsongzi.mydb.backend.parser.statement 包。
 * 对外提供了 Parse(byte[] statement) 方法，核心就是一个调用 Tokenizer 类分割 Token，并根据词法规则包装成具体的 Statement 类并返回
 *
 * @author 小子松
 * @since 2023/8/3
 */
public class Parser {
    ...
    /**
     * 对外提供的方法。
     * 核心是调用 Tokenizer 类分割 Token，并根据词法规则包装成具体的 Statement 类并返回
     * @param statement statement类型
     * @return 包装完成的 Statement 类
     * @throws Exception Error 中定义的异常、Java提供的异常
     */
    public static Object Parse(byte[] statement) throws Exception {
        // 新建 Tokenizer 实例，调用 peek 方法分词，弹出分词结果
